...
Text Text Text Text Text Text  Text Text Text Text Text Text Text Text Text  Text Text Text Text Text Text Text Text Text Text  Text Text Text Text Text Text  Text Text.  [@Neuro2013] might want to know about  text text text text Text Text Text Text  Text Text Text Text Text Text  Text Text. [@Gene2012] might want to know about  text text text text
Text Text Text Text Text Text  Text Text Text Text Text Text Text Text Text  Text Text Text Text Text Text Text Text Text Text  Text Text Text Text Text Text  Text Text.  [@Neurobot2013] might want to know about  text text text text
...
## Original Research Articles, Clinical Trial Articles, and Technology Reports
...
For Clinical Case Studies the following sections are mandatory:
 ...
 - Results: This section may be divided by subheadings. Include diagnosis and treatment.
 - Concluding Remarks
...
\textbf{Table\ref{Tab:02}} shows the resolution requirements for the figures. The figures must be legible:
 ...
 1. The smallest visible text is no less than 8 points in height, when viewed at actual size.
 1. Solid lines are not broken up.
 1. Image areas are not pixelated or stair stepped.
 1. Text is legible and of high quality.
 1. Any lines in the graphic are no smaller than 2 points width.
 1. The actual size of the figure must be of at least 8.5 cm.
