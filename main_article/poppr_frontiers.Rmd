...
constructed using the `glSim` function in adegenet [@jombart2011adegenet]. Since
this function would simulate panmictic populations with no error in genotype 
calls, we wrote custom functions to randomly insert errors into the sequences
given a probability. Clonality was simulated by randomly sampling genotypes with
replacement before error and missing data generation. 
