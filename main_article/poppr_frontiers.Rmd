...
method for assessing population differentiation through methods such as $F_{st}$,
AMOVA, and Mantel tests. Of course, confidence in distance metrics is only related to the confidence of the markers. If a single 
