...
We utilized simulated data
constructed using the `glSim` function in adegenet [@jombart2011adegenet] to obtain a SNP data set for demonstration. Two diploid data sets were created, each with 10k SNPs (25%
...
alike. The number of mutations and missing data per sample were determined by
