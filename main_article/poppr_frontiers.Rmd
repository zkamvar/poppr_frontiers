...
> ##### I am wondering if need to structure the paper into MEthods and Demo sections, rather that results. #####
...
which is common and expected for clonal organisms. In other minimum spanning
...
utilize this strategy, thus we implemented a C function to walk the sapce of minimum spanning trees based on genetic distance to connect groups of nodes with edges
of equal weight. 

To demonstrate the utility of minimum spanning networks with reticulation, we used two
...
result in a few, large communities. We also created contingency tables of the
...
entropy indicates presence of a few large communities whereas high entropy indicates presence of many
small communities.
