...
```{r, fig_ia, echo = FALSE, out.height = "90mm", out.width = "180mm", fig.width = 10, fig.height = 5, fig.keep = "last", dev = c("pdf", "tiff"), dpi = 1200, dev.args = list(tiff = list(compression = 'lzw'))}
...
legend("topright", lty = 1, col = c("black", "blue"), bty = "n",
...
boxplot(data.frame(clonal = clone.samp, sexual = sex.samp), 
        ...
        cex.axis = 1.5,
        cex.main = 1.5)
legend("topleft", legend = "", pch = "B", cex = 2, xjust = -1, yjust = -1, bty = "n")
par(mar = c(5, 4, 4, 2) + 0.1)
layout(matrix(1))
```
<!--
...
variants among 100 individuals. Each window analyzed variants within 100nt
