...
@davey2011genome; @davey2010rad]. With this larger number of markers, the genetic
resolution is much greater, but the chance of genotyping error is also greatly
increased [@mastretta2015restriction]. Taking this fact and occasional somatic mutations into
...
introduce a new method for collapsing unique multilocus genotypes
...
genclone objects such as `bruvo.dist`, which in particular applies to
...
together if all samples in the cluster are at a distance less than the
...
preliminary ultra-metric trees based on genetic distance. This algorithm
...
> ############ Need a reference for OpenMP!!! ##############

## Demonstration data: *P. infestans* {-}

We utilize data from the microbe *Phytophthora infestans* to show how the `mlg.filter`
...
which 18 multilocus lineages would be resolved. We used these thresholds to
