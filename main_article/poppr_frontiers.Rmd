...
```{r, microboot, cache = TRUE, message = FALSE, out.width = "80mm", out.height = "80mm", fig.width = 5, fig.height = 5}
library("poppr")
...
```{r, monolinia_curve, cache = TRUE, message = FALSE, out.width = "80mm", out.height = "80mm", fig.width = 5, fig.height = 5}
library("poppr")
data("monpop", package = "poppr")
set.seed(20150428)
invisible(genotype_curve(monpop, sample = 1000, quiet = TRUE))
```
