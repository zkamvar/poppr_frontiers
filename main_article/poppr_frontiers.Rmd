...
```{r, pinf_data, echo = FALSE, message = FALSE, out.height = "80mm", out.width = "80mm", fig.width = 4*1.5, fig.height = 4*1.5}
...
```{r, microboot2, cache = TRUE, ref.label = "microboot", echo = FALSE, out.height = "80mm", out.width = "80mm", fig.width = 5, fig.height = 5}

```

## Figure 4 {-}

```{r, monilinia, cache = TRUE, ref.label = "monilinia_curve", echo = FALSE, out.height = "80mm", out.width = "80mm", fig.width = 5, fig.height = 5, fig.keep = "last", message = FALSE}
