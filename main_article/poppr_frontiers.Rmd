...
samples in each MLG as vertex weights [@csardi2006igraph; @rosvall2008map]. The
number and size of resulting communities were compared along with the accuracy
of prediction of an outlier group of MLGs derived from a single introduction
event into Cape Sebastian, OR [kamvar2015spatial].
...
We found that the infomap algorithm was able to find 
