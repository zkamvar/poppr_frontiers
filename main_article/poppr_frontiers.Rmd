...
forest pathogen *Hymenoscyphus pseudoalbidus* [@gross2014population]. It has also been used to implement real-time, online shinyR based tools for visualizing relationships among unkown MLGs in reference databases  (http://phytophthora-id.org/) [@grunwald2011phytophthora]
<!-- 
...
(Fig. 3). Note that the reticulated network (Fig. 3B) showed patterns corresponding with those resulting from a discrimnant analysis of principal components (Fig. 3D) [@jombart2010discriminant].
...
new genotypes (Fig. 5). The following code was used:
