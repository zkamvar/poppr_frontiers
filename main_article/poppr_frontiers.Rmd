...
```{r, microboot2, cache = TRUE, ref.label = "microboot", echo = FALSE, out.height = "85mm", out.width = "85mm", fig.width = 5, fig.height = 5, dev = c("postscript", "pdf", "tiff"), dpi = 1200, dev.args = list(tiff = list(compression = 'lzw'))}
