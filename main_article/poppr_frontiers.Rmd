...
```{r, monilinia_curve, cache = TRUE, message = FALSE, out.width = "80mm", out.height = "80mm", fig.width = 5, fig.height = 5, fig.show = "hide", fig.keep = "last"}
library("poppr")
library("ggplot2")
...
![Fig. 3](poppr_frontiers_files/figure-latex/monilinia_curve-1.pdf)
