...
provides endusers with a broader ability to analyze data hierarchically in R
across packages.
...
Several population geenetics packages in R are currenlty going through a major upgrade and have not yet been updated in CRAN. We will push *poppr* 2.0 to CRAN, once all other reverse dependent packages have been updated. 
...
allowed gave us the ability to tailor our tools for the needs of the researchers
who use them. 
