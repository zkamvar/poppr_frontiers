...
i(\url{https://github.com/NESCent/r-popgen-hackathon}) and have not yet
...
\includegraphics[width=85mm,height=85mm]{poppr_frontiers_files/figure-latex/Figure-2-1} \end{CodeChunk}
...
\includegraphics[width=85mm,height=85mm]{poppr_frontiers_files/figure-latex/Figure-4-1} \end{CodeChunk}
...
\includegraphics[width=85mm,height=85mm]{poppr_frontiers_files/figure-latex/Figure-5-1} \end{CodeChunk}
...
\includegraphics[width=85mm,height=60mm]{poppr_frontiers_files/figure-latex/Figure-6-1} \end{CodeChunk}
