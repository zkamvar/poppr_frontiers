...
\section*{Population Strata and
Hierarchies}\label{population-strata-and-hierarchies}
\addcontentsline{toc}{section}{Population Strata and Hierarchies}
...
\section*{Clonal identification}\label{clonal-identification}
\addcontentsline{toc}{section}{Clonal identification}
...
\section*{Minimum Spanning Networks with
Reticulation}\label{minimum-spanning-networks-with-reticulation}
\addcontentsline{toc}{section}{Minimum Spanning Networks with
Reticulation}
...
\addcontentsline{toc}{section}{Bootstrapping}
...
\section*{Genotype Accumulation
Curve}\label{genotype-accumulation-curve}
\addcontentsline{toc}{section}{Genotype Accumulation Curve}
...
\section*{Index of association}\label{index-of-association}
\addcontentsline{toc}{section}{Index of association}
...
\includegraphics[width=180mm,height=90mm]{poppr_frontiers_files/figure-latex/fig_ia-1} \end{CodeChunk}
...
analyzed variants within 100nt chunks. The black line indicates clonal
