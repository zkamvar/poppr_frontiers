...
\includegraphics[width=80mm,height=80mm]{poppr_frontiers_files/figure-latex/microboot-1} \end{CodeChunk}
...
\includegraphics[width=80mm,height=80mm]{poppr_frontiers_files/figure-latex/monolinia_curve-1} \end{CodeChunk}
