...
\title[Novel tools for population genetics]{Novel tools for analysis genome-wide population genetic data with
...
\emph{Hymenoscyphus pseudoalbidus} (Gross et al., 2014).
...
the invasive forest pathogen hymenoscyphus pseudoalbidus.
