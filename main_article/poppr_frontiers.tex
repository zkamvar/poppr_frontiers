...
are different. We provide a transparent method for collapsing unique
multilocus genotypes determined by naive string comparison into
...
standardized in 2001 as \(\bar{r}_d\) by agapow 2001 to address the
issue of scaling with increasing number of loci. When this metric came
out, it was utilized for dominant and co-dominant markers such as AFLPs,
SNP panels, and microsatellite markers. Unfortunately, it would be
erroneous and wasteful to apply the index of association to large
numbers of markers as chances of linkage are expected to go up,
weakening the any true signal of clonal reproduction present in the
data. For this reason, we have devised two approaches for addressing
using the index of association for large numbers of markers
