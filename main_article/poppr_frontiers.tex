...
methods have now been renamed \texttt{strata} in \emph{adegenet}. This
migration provides end users with a broader ability to analyze data
hierarchically in R across packages.
