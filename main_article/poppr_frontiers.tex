...
dendrogram with bootstrap support using the function \texttt{aboot}
(Fig. 3).
...
\includegraphics{poppr_frontiers_files/figure-latex/microboot-1.pdf}

\subsection*{Figure 4}\label{figure-4}
\addcontentsline{toc}{subsection}{Figure 4}

\includegraphics{poppr_frontiers_files/figure-latex/monolinia_curve-1.pdf}
