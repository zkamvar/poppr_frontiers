...
\begin{quote}
NIK: I am wondering if need to structure the paper into MEthods and Demo
sections, rather that results.
\end{quote}
...
networks that were based on the igraph function
...
trees. Due to the way igraph has implemented Prim's algorithm, it is not
possible to utilize this strategy, thus we implemented a C function to
walk the sapce of minimum spanning trees based on genetic distance to
...
\subsection*{Demonstration: Clonal
identification}\label{demonstration-clonal-identification}
\addcontentsline{toc}{subsection}{Demonstration: Clonal identification}
...
\subsection*{Demonstration: Minimum Spanning Network
Reticulation}\label{demonstration-minimum-spanning-network-reticulation}
\addcontentsline{toc}{subsection}{Demonstration: Minimum Spanning
...
\includegraphics{poppr_frontiers_files/figure-latex/pinf_data-1} \end{CodeChunk}
...
\addcontentsline{toc}{subsection}{Supplementary figure?}

\begin{CodeChunk}

\includegraphics{poppr_frontiers_files/figure-latex/pinf_tree-1} \end{CodeChunk}
