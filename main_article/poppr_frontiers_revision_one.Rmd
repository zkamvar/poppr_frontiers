...
nearest neighbor, and Unweighted Pair Group Method with Arithmetic Mean (UPGMA, 
average neighbor) [@sokal1958statistical].
...
```{r, Figure-4, cache = FALSE, results = "hide", ref.label = "microboot", echo = FALSE, out.height = "85mm", out.width = "85mm", fig.width = 5, fig.height = 5, dev = c("pdf", "tiff"), dpi = 1200, dev.args = list(tiff = list(compression = 'lzw'))}

```

## Figure 5 {-}

```{r, Figure-5, cache = FALSE, results = "hide", ref.label = "monilinia_curve", echo = FALSE, out.height = "85mm", out.width = "85mm", fig.width = 5, fig.height = 5, fig.keep = "last", message = FALSE, dev = c("pdf", "tiff"), dpi = 1200, dev.args = list(tiff = list(compression = 'lzw'))}
